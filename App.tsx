          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <Card className="lg:col-span-2 p-8 border-none shadow-lg">
                  ...
                  <div className="bg-slate-50 p-6 rounded border border-slate-200 mb-8">
                      ...
                      <Button onClick={addFieldToTemplate} className="w-full mt-2 border border-dashed border-slate-300 bg-black hover:bg-slate-50 text-emerald-500">+ Append Data Field</Button>
